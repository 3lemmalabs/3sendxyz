...
import PricingEmailLimitNote from '@/components/PricingEmailLimitNote';
import { PricingFreeAllowanceCard } from '@/components/PricingFreeAllowanceCard';
import PricingNonProfitNote from '@/components/PricingNonProfitNote';
...
export default function PricingPage() {
  return (
    <main className="col" style={{ gap: 24 }}>
      ...
      <PricingEmailLimitNote />

      <PricingNonProfitNote />
    </main>
  );
}
